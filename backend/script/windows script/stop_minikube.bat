@echo off
REM filepath: c:\Users\coren\Desktop\devops\Project\devops\backend\script\stop_minikube.bat
REM (Converted from provided stop_minikube.sh — content starts minikube)
REM Start minikube
minikube start

REM Enable minikube docker daemon
